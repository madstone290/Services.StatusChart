...
window.addEventListener("load", () => {
    ...
    const entityPointEventRender = function (error, canvasElement, containerElement) {
        ...
        barcodeElement.innerText = error.barcode;
        tooltipElement.appendChild(barcodeElement);

        const productElement = document.createElement("div");
        productElement.innerText = error.productNo + " " + error.productName;
        tooltipElement.appendChild(productElement);

        const descElement = document.createElement("div");
        descElement.innerText = error.description;
        tooltipElement.appendChild(descElement);

        const timeElement = document.createElement("div");
        timeElement.innerText = dayjs(error.time).format("HH:mm:ss");
    ...
    const entityRangeEventRender = function (event, canvasElement, containerElement) {
        ...
        typeElement.innerText = event.productName + " 라인 " + event.type;
